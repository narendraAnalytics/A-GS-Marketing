...
- Line 1: the hook, reworded from the given hook to actually stop the
  ...
  Use one of these formulas rather than a flat statement of fact:
...
HASHTAGS
- Exactly 3 hashtags, placed logically at the end: one broad/industry tag
  (e.g. #AISecurity or #AITRiSM), one niche/specific tag (e.g. #LLMGateway,
  #AIGuardrails, or #PromptInjection), and one branded tag (#AGS or
  similar). Avoid generic spam tags like #marketing or #business.
"""
